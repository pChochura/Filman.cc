...
object VidsrcExtractor : EmbedExtractor {
    ...
    fun ndonQLf1Tzyx7bMG(a: String): String {
        val b = 3
    ...
    fun sXnL9MQIry(a: String): String {
    ...
    fun ihWrImMIGL(a: String): String {
        val b = a.reversed()
        val c =
            b
                .map { ch ->
    ...
    fun o2VSUnjnZl(a: String): String {
        val shift = 3
        return a
            .map { char ->
                when (char) {
    ...
    fun oi3v1dAlaM(a: String): String {
        val b = a.reversed()
    ...
    fun tsA2KGDGux(a: String): String {
        val b = a.reversed()
        val c = b.replace("-", "+").replace("_", "/")
        val d = String(decodeBase64(c))
        var e = ""
    ...
    fun joAHUMCLXV(a: String): String {
        val b = a.reversed()
        val c = b.replace("-", "+").replace("_", "/")
        val d = String(decodeBase64(c))
        var e = ""

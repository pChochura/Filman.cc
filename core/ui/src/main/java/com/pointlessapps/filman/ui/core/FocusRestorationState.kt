...
val LocalFocusRestorationState = staticCompositionLocalOf<FocusRestorationState?> { null }

@Composable
fun Modifier.withFocusRestoration(itemKey: String): Modifier {
...
@Composable
fun <T> Modifier.withFocusRestoration(
    itemIndex: Int,
    items: List<T>,
...
@Composable
fun Modifier.sectionFocusRestorer(
...
enum class SectionFocusRestorationId(
    val prefix: String,
) {
    FEATURED("featured_"),
    EPISODES("episodes_"),

...
class VideoUrlResolverMatchingTest {
    ...
    private fun selectBestMatch(
        ...
        return scoredVideos.filter { it.second > 0 }
            .maxWithOrNull(
    ...
    fun testExactMatchScoresHighest() {
        val target = TvShowSourceSettings(
            serverName = "vidoza",
            version = "Dubbing",
            quality = "1080p",
    ...
    fun testDubbingPreferredOverServerMismatch() {
        ...
        val candidateUpstreamDubbing = ExtractedVideo(
        ...
        val candidateVidozaLektor = ExtractedVideo(
    ...
    fun testLatencyBreaksTies() {
        ...
        val candidateFast = ExtractedVideo(
        ...
        val candidateSlow = ExtractedVideo(

package com.pointlessapps.filman.ui.movies
...
sealed interface MoviesEvent : FilmanEvent {
...
class MoviesViewModel(
    ...
    ): MoviesEffect = MoviesEffect.NavigateToDetails(request ?: DetailsRequest.Url(url))
    ...
    private fun loadData() {
        ...
        currentLoadJob =
            launchHandled(
                ...
                val (highestRatingResult, mostViewedResult, recentlyAddedResult) =
                    awaitAll(
